...
def build_bateman_video(url: str, offset_seconds: int | None = None) -> BatemanVideoArtifacts:
    ...
    if offset_seconds is not None:
        console.print(
            f"Using input offset => [bold #FFC0CB]offset-seconds:[/bold #FFC0CB] [#DDA0DD]{offset_seconds}[/#DDA0DD]"
        )
        delay_in_seconds = offset_seconds
    else:
